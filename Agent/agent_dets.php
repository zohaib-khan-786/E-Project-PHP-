                    ...
                    <?php
                          foreach($rows as $row) {
                            if ($row['role'] != 'Admin') {
                                ...
                                echo "<div class='row no-gutters border-bottom py-2'>";
                                echo "<div class='col-6 pr-3 border-right font-weight-bold'>ID:</div>";
                                echo "<div class='col-6 pl-3'>{$row['id']}</div>";
                                echo "</div>";
                                
                                echo "<div class='row no-gutters border-bottom py-2'>";
                                echo "<div class='col-6 pr-3 border-right font-weight-bold'>Name:</div>";
                                echo "<div class='col-6 pl-3'>{$row['name']}</div>";
                                echo "</div>";
                                
                                echo "<div class='row no-gutters border-bottom py-2'>";
                                echo "<div class='col-6 pr-3 border-right font-weight-bold'>Email:</div>";
                                echo "<div class='col-6 pl-3'>{$row['email']}</div>";
                                echo "</div>";
                                
                                echo "<div class='row no-gutters border-bottom py-2'>";
                                echo "<div class='col-6 pr-3 border-right font-weight-bold'>Status:</div>";
                                echo "<div class='col-6 pl-3'>{$row['status']}</div>";
                                echo "</div>";
                                
                                echo "<div class='row no-gutters py-2'>";
                                echo "<div class='col-6 '>";
                                echo "<div class='col-6 pr-3 border-right font-weight-bold'>Actions:</div>";
                                echo "</div>";
                                echo "<div class='col-6'>";
                                echo "<button class='btn btn-warning btn-sm ' onclick=\"updateAgent('{$row['id']}')\">Update</button>";
                                echo "<button class='btn btn-danger btn-sm ms-2' onclick=\"deleteAgent('{$row['id']}')\">Delete</button>";
                                echo "</div>";
                                echo "</div>";
